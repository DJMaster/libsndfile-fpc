...
type
  ...
  sf_vio_seek = function (offset: sf_count_t; whence: cint; user_data: pointer): sf_count_t; cdecl;
  sf_vio_read = function (ptr: pointer; count: sf_count_t; user_data: pointer): sf_count_t; cdecl;
  sf_vio_write = function (const ptr: pointer; count: sf_count_t; user_data: pointer): sf_count_t; cdecl;
...
function sf_open(const path: pchar; mode: cint; sfinfo: PSF_INFO): PSNDFILE; cdecl; external LIB_SNDFILE;
...
function sf_open_fd(fd: cint; mode: cint; sfinfo: PSF_INFO; close_desc: cint): PSNDFILE; cdecl; external LIB_SNDFILE;

function sf_open_virtual(sfvirtual: PSF_VIRTUAL_IO; mode: cint; sfinfo: PSF_INFO; user_data: pointer): PSNDFILE; cdecl; external LIB_SNDFILE;
...
function sf_error_str(sndfile: PSNDFILE; str: pchar; len: size_t): cint; cdecl; external LIB_SNDFILE;


(* Return TRUE if fields of the SF_INFO struct are a valid combination of values. *)

function sf_command(sndfile: PSNDFILE; command: cint; data: pointer; datasize: cint): cint; cdecl; external LIB_SNDFILE;
...
function sf_seek(sndfile: PSNDFILE; frames: sf_count_t; whence: cint): sf_count_t; cdecl; external LIB_SNDFILE;
...
function sf_set_string(sndfile: PSNDFILE; str_type: cint; const str: pchar): cint; cdecl; external LIB_SNDFILE;

function sf_get_string(sndfile: PSNDFILE; str_type: cint): pchar; cdecl; external LIB_SNDFILE;
...
function sf_read_raw(sndfile: PSNDFILE; ptr: pointer; bytes: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_write_raw(sndfile: PSNDFILE; const ptr: pointer; bytes: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
...
function sf_readf_short(sndfile: PSNDFILE; ptr: pcshort; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_writef_short(sndfile: PSNDFILE; const ptr: pcshort; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;

function sf_readf_int(sndfile: PSNDFILE; ptr: pcint; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_writef_int(sndfile: PSNDFILE; const ptr: pcint; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;

function sf_readf_float(sndfile: PSNDFILE; ptr: pcfloat; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_writef_float(sndfile: PSNDFILE; const ptr: pcfloat; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;

function sf_readf_double(sndfile: PSNDFILE; ptr: pcdouble; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_writef_double(sndfile: PSNDFILE; const ptr: pcdouble; frames: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
...
function sf_read_short(sndfile: PSNDFILE; ptr: pcshort; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_write_short(sndfile: PSNDFILE; const ptr: pcshort; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;

function sf_read_int(sndfile: PSNDFILE; ptr: pcint; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_write_int(sndfile: PSNDFILE; const ptr: pcint; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;

function sf_read_float(sndfile: PSNDFILE; ptr: pcfloat; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_write_float(sndfile: PSNDFILE; const ptr: pcfloat; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;

function sf_read_double(sndfile: PSNDFILE; ptr: pcdouble; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
function sf_write_double(sndfile: PSNDFILE; const ptr: pcdouble; items: sf_count_t): sf_count_t; cdecl; external LIB_SNDFILE;
...
function sf_wchar_open(wpath: pchar; mode: cint; sfinfo: PSF_INFO): PSNDFILE; cdecl; external LIB_SNDFILE;
// #endif
...
function sf_set_chunk(sndfile: PSNDFILE; const chunk_info: PSF_CHUNK_INFO): cint; cdecl; external LIB_SNDFILE;
...
function sf_get_chunk_iterator(sndfile: PSNDFILE; const chunk_info: PSF_CHUNK_INFO): PSF_CHUNK_ITERATOR; cdecl; external LIB_SNDFILE;
...
function sf_next_chunk_iterator(iterator: PSF_CHUNK_ITERATOR): PSF_CHUNK_ITERATOR; cdecl; external LIB_SNDFILE;
...
function sf_get_chunk_size(const it: PSF_CHUNK_ITERATOR; chunk_info: PSF_CHUNK_INFO): cint; cdecl; external LIB_SNDFILE;
...
function sf_get_chunk_data(const it: PSF_CHUNK_ITERATOR; chunk_info: PSF_CHUNK_INFO): cint; cdecl; external LIB_SNDFILE;
